...
const Rectangle = (props: DottedProps) => {
  ...
  function handleMouseUp(event: any) {
    ...
    newProblems[props.index].data = [...(newProblems[props.index].data ? newProblems[props.index].data : []), { x: startX / canvas.width, y: startY / canvas.height, width: width / canvas.width, height: height / canvas.height }];
