    ...
    return (
      <>
        ...
        <>
          ...
          <Divider />
          <Radio.Group value={props.problemList[props.index].data ? props.problemList[props.index].data.choiceIndex : undefined}
            onChange={(e) => {
              const newProblems: any[] = [...props.problemList];
          ...
          <>
            ...
            <br />
            <br />
            <Input disabled={(!props.problemList[props.index].data) || !(props.problemList[props.index].choice[props.problemList[props.index].data.choiceIndex].needInput)}
              onChange={(e) => {
                const newProblems: any[] = [...props.problemList];
    ...
    return (
      <>
        ...
        <>
          ...
          <Radio.Group value={props.problemList[props.index].data}
            onChange={(e) => {
              const newProblems: any[] = [...props.problemList];
