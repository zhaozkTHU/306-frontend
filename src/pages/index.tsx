...
const LoginScreen = (props: LoginScreenPorps) => {
  ...
  return (
    ...
    >
      <h1 style={{textAlign: 'center', marginTop: '5%', color:'rgba(62, 132, 239, 0.953)'}}>306众包平台</h1>
      <div
        style={{
          zIndex: -1,
          position: "absolute",
      ...
      >
        ...
        >
          <ProCard
            ...
            // hoverable={false}
          >
            <ProCard colSpan={"5%"} style={{height: '100%', backgroundColor: 'rgba(255, 255, 255, 0)'}}
              onClick = {() => {
                CarouselRef.current?.prev?.()
              }}
            >   
            </ProCard>
            <ProCard colSpan={"90%"} style={{height: '100%', backgroundColor: 'rgba(255, 255, 255, 0)'}}>
            ...
            >
              ...
              <div>
                ...
                <p className="loginLeft" >306众包平台抽成很少，操作简单，我在这上面兼职标注，挣了不少钱。 ——zmh</p>
                <p className="loginLeft" >306众包平台非常适合我们中介，因为这上面有很多的需求方和标注者，谈拢一单简直太容易了。 ——zkk</p>
              </div>
            </Carousel>
            </ProCard>
            <ProCard colSpan={"5%"} style={{height: '100%', backgroundColor: 'rgba(255, 255, 255, 0)'}}
          ...
          >
            ...
            >
              ...
              <h2 style={{ textAlign: "center", color: 'rgba(62, 132, 239, 0.99)', margin:'0%'}}>登录</h2>
              <Divider/>
